        ...
        <div class="flex flex-col w-[calc(525/1000*100%)] shrink-0 gap-[14px]">
            ...
            >
                ...
                <div class="flex items-center gap-4">
                    ...
                    >
                        <span
                            class="font-semibold text-xs text-white uppercase"
                            >{{ headOfFamily.marital_status }}</span
                        >
                    </div>
                </div>
            ...
            >
                ...
                <div class="flex flex-col gap-[14px]">
                    <div
                        ...
                        v-for="family_member in headOfFamily.family_members"
                        :key="index"
                    >
                        <div class="flex items-center gap-4">
                            <div
                            ...
                            >
                                <img
                                    :src="family_member.profile_picture"
                                    class="w-full h-full object-cover"
                                    alt="photo"
                                />
                            </div>
                            <div class="flex flex-col gap-[6px] w-full">
                                ...
                                <p class="flex items-center gap-1">
                                    ...
                                    <span
                                        class="font-medium text-sm text-desa-secondary"
                                        >{{ family_member.occupation }}</span
                                    >
                                </p>
                            </div>
                            <p class="font-medium leading-5 text-nowrap">
                                {{
                                    calculateAge(family_member.date_of_birth)
                                }}
                                tahun
                            </p>
                        </div>
                    ...
                    <div id="Events" class="flex flex-col gap-6 hidden">
                        ...
                        >
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex flex-col gap-[6px] w-full">
                                    <p
                                        class="font-semibold leading-5 line-clamp-1"
                                    >
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        />
                                        <p
                                            class="font-medium text-sm text-desa-orange"
                                        >
                    ...
                    <div id="Applicants" class="flex flex-col gap-6 hidden">
                        ...
                        >
                            ...
                            <div class="flex flex-col gap-1">
                                ...
                                <p
                                    class="font-medium leading-5 text-desa-secondary"
                                >
                                    Penanggung jawab:
                                    <span
                                        class="font-semibold text-desa-dark-green"
                                    >
                                        Uzumaki Asep
                                    </span>
                                </p>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p
                                        class="font-semibold leading-5 text-desa-dark-green"
                                    >
                                        3 Jan 2025
                                    </p>
                                    <p
